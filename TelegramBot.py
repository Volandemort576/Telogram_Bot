...
def news(message):
    ...
    bot.send_message(message.chat.id, 'Нажмите на какую-нибудь кнопку.\n\rЕсли нашли новости украинcкой пропоганды,\n\rто пишите мне на почту: sanek1080p@gmail.com', reply_markup=kb)
...
def cont(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, 'Кажется новости закончились')
